...
class PersonalExpenseFormDialog extends StatefulWidget {
  final ExpenseService expenseService;
  final Trip trip;
  final Expense? expense;
  final Function(Trip) onSave;

  const PersonalExpenseFormDialog({
    super.key,
  ...
  @override
  State<PersonalExpenseFormDialog> createState() =>
      _PersonalExpenseFormDialogState();
}

class _PersonalExpenseFormDialogState extends State<PersonalExpenseFormDialog> {
              ...
              TextButton(
                onPressed: () async {
                  if (_expenseNameController.text.isNotEmpty &&
                    ...
                    try {
                      final newTrip = await widget.expenseService
                          .addOrUpdatePersonalExpense(
                        widget.trip.uid!,
                        Expense(
